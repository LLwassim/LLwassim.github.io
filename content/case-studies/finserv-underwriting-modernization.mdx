---
title: "Financial Services Underwriting Modernization"
role: ["Senior Solutions Architect (ProServe)", "Technical Lead"]
...
summary: "Led an AWS ProServe engagement to re-architect a major bank's mortgage underwriting platform with resilient event orchestration, multi-signal autoscaling, and disciplined observability, shrinking credit decision latency while satisfying regulatory scrutiny."
outcomes:
...
context: "A major financial services client's underwriting operations were bound to a monolithic workflow engine that stalled during bursty loan demand. Manual recovery procedures regularly stretched into multi-day efforts, and the audit backlog increased whenever remediation work bypassed formal controls."
decisions:
...
order: 3
category: "Systems"
image: "/images/aws-finserv-banner.png"
---
